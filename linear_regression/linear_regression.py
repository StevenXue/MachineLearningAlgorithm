...
class LinearRegression:
    ...
    learning_rate: float
        梯度下降学习率
    regularization: L1Regularization or L2Regularization or None
        正则化
    gradient: Bool
        是否采用梯度下降法或正规方程法。
        若使用了正则化，暂只支持梯度下降
...
def main():
    ...
    model = LinearRegression(n_iterations=3000, regularization=L2Regularization(alpha=0.5))
