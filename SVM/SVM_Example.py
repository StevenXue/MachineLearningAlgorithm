...
from SVM.SVM_Model import SVM, RBF, accuracy, plot_in_2d
...
def main():
    ...
    print('Classification accuracy (%s): %s' % (kernel, accuracyRate))

    # 原来的数据的呈现
    # plot_in_2d(X_test, y_test, title="Origin Data", accuracy=accuracyRate)
