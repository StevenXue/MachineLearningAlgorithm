...
class DecisionTree(object):
    ...
    def __init__(self, min_samples_split=2, min_impurity=1e-7,
        ...
        # (classif.=>info gain, regr=>variance reduct.)
        # 切割树的方法，gini，方差等
    ...
    def _build_tree(self, X, y, current_depth=0):
        ...
        respective y on the feature of X which (based on impurity)
        ...
        if n_samples >= self.min_samples_split and current_depth <= self.max_depth:
            ...
            for feature_i in range(n_features):
                ...
                for threshold in unique_values:
                    # Divide X and y depending on if the feature value of X at
    ...
    def predict_value(self, x, tree=None):
        """
        Do a recursive search down the tree and make a prediction of the
        data sample by the value of the leaf that we end up at
        """

        if tree is None:
            tree = self.root

        # If we have a value (i.e leaf) => return value as the prediction
